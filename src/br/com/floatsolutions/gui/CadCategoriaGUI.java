...
import br.com.floatsolutions.gui.tablemodel.CategoriaTableModel;
import br.com.floatsolutions.gui.tablemodel.renderer.CategoriaTableRenderer;
...
public class CadCategoriaGUI extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new Color(153, 153, 153)), "Listagem de Categorias", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new Font("Tahoma", 0, 11), new Color(153, 153, 153)));
    ...
    public void findAll(){
        ...
        List<Categoria_Produto> list = categoriaService.findAll();
        
        if(!list.isEmpty()){
            tableModel.removeAll();
            for(Categoria_Produto u: categoriaService.findAll()){
                tableModel.addRow(u); 
            }            
        }else{
    ...
    private void findWithParameter(String pParam){
        ...
        List<Categoria_Produto> list = categoriaService.findByName(pParam);        
        if(list.isEmpty()){
            findAll();
        }else{
            tableModel.removeAll();
            for(Categoria_Produto p : list){
                tableModel.addRow(p);
            }  
        }        
    }
    ...
    public Categoria_Produto getObject(){
        return categoria;
    }
