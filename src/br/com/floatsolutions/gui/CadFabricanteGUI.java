...
import br.com.floatsolutions.gui.tablemodel.FabricanteTableModel;
import br.com.floatsolutions.gui.tablemodel.renderer.FabricanteTableRenderer;
...
public class CadFabricanteGUI extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel3.setBorder(BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new Color(153, 153, 153)), "Localizar Fabricante", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new Font("Tahoma", 0, 11), new java.awt.Color(153, 153, 153)));
    ...
    private void completeData(){
        provider = new Fabricante_Veiculo();
        provider.setId(ParseInteger.tryParseToInt(txtCod.getText()));
        provider.setDescricao(txtName.getText());      
    }
    ...
    private void findAll(){
        ...
        List<Fabricante_Veiculo> list = providerService.findAll();
        
        if(list != null){
            tableModel.removeAll();
            for(Fabricante_Veiculo p : list){
                tableModel.addRow(p);
            } 
        }else{
    ...
    private void findWithParameter(String pParam){
        ...
        List<Fabricante_Veiculo> list = providerService.findByName(pParam);        
        if(list.isEmpty()){
            findAll();
        }else{
            tableModel.removeAll();
    ...
    private void getTable(){
        ...
        if(tableProvider.getSelectedRow() != -1){
            ...
            txtName.setText(provider.getDescricao());
            btnDelete.setEnabled(true);
        }
    }

    public Fabricante_Veiculo getObject(){
        return provider;
    }
