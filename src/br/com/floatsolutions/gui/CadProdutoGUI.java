...
import br.com.floatsolutions.gui.tablemodel.ProdutoTableModel;
...
public class CadProdutoGUI extends javax.swing.JDialog {
    ...
    private void completeData(){
        ...
        produto.setDescricao(txtName.getText());      
        produto.setCategoria((Categoria_Produto)cbCategoria.getSelectedItem()); 
    ...
    private void popCategoria(){
        ...
        for(Categoria_Produto c:categoriaService.findAll()){
    ...
    private void getTable(){
        ...
        if(tableProduto.getSelectedRow() != -1){
            ...
            txtName.setText(produto.getDescricao());
            cbCategoria.getModel().setSelectedItem((Categoria_Produto)produto.getCategoria());
