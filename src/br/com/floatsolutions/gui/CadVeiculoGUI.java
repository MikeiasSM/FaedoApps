...
import br.com.floatsolutions.model.service.FabricanteService;
...
public class CadVeiculoGUI extends javax.swing.JDialog {
    ...
    private Fabricante_Veiculo provider;
    ...
    private void initComponents() {
        ...
        jPanel2.setBorder(BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new Color(153, 153, 153)), "Localizar Veiculos", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new Font("Tahoma", 0, 11), new Color(153, 153, 153)));
    ...
    private void btnAddProviderActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddProviderActionPerformed
        ...
        cbProvider.setSelectedItem((Fabricante_Veiculo)provider);
    ...
    private void popProvider(){
        ...
        for(Fabricante_Veiculo p: providerService.findAll()){
    ...
    private void getTable(){
        ...
        if(tableVehicle.getSelectedRow() != -1){
            ...
            cbProvider.setSelectedItem((Fabricante_Veiculo)vehicle.getFabricante());
            btnDelete.setEnabled(true);
        }
    }
    
    private void setObject(Fabricante_Veiculo pProvider){
        if(pProvider != null){
            provider = pProvider;
        }
    }
    ...
    private void completeData(){
        ...
        vehicle.setFabricante((Fabricante_Veiculo)cbProvider.getSelectedItem());
