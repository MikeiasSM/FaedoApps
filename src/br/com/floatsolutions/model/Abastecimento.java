...
public class Abastecimento implements Serializable{
    ...
    public void setId(Integer id_abastecimento) {
        this.id_abastecimento = id_abastecimento;
    }
    ...
    public int hashCode() {
        int hash = 7;
        hash = 53 * hash + Objects.hashCode(this.id_abastecimento);
        return hash;
    }
    ...
    public boolean equals(Object obj) {
        ...
        if (!Objects.equals(this.id_abastecimento, other.id_abastecimento)) {
            return false;
        }
        return true;
    }
